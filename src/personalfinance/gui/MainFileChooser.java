...
public class MainFileChooser extends JFileChooser {
    ...
    public MainFileChooser(MainFrame frame) {
        ...
        UIManager.put("FileChooser.saveDialogFileNameLabelText", Text.get("FC_OPEN"));
        ...
        UIManager.put("FileChooser.acceptAllFilesFilterText", Text.get("FC_ALL_FILTER"));

        updateUI();
    }

    public int open(){
        return super.showSaveDialog(mainFrame);
    }
